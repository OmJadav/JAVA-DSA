public class Functions_Questions {
    ...
    //Que 1 Write a Java method to compute the average of three numbers..
    public static double aveOfthree(double a,double b,double c){
            return (a+b+c)/3;
    }

    //Que 2 Write a method named isEven that accepts an int argument. The method
    ...
    //Que 3 Write a Java program to check if a number is a palindrome in Java? ( 121 is a
    ...
    //Que 4 Write a Java method to compute the sum of the digits in an integer
