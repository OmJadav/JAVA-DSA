...
class ElectricityBill {
    ...
    double calculateBillResidential(double unitsConsumed) {
        if (unitsConsumed <= 50) {
            return unitsConsumed * 3.05;
        } else if (unitsConsumed <= 100) {
            return (50 * 3.05) + (unitsConsumed - 50) * 3.5;
        } else if (unitsConsumed <= 250) {
            return (50 * 3.05) + (100 * 3.5) + (unitsConsumed - 150) * 4.15;
        } else {
            return (50 * 3.05) + (100 * 3.5) + (250 * 4.15) + (unitsConsumed - 400) * 5.2;
        }
    }

    double calculateBillCommercial(double unitsConsumed) {
        if (unitsConsumed <= 50) {
            return unitsConsumed * 2.79;
        } else if (unitsConsumed <= 100) {
            return (50 * 2.79) + (unitsConsumed - 50) * 3.68;
        } else if (unitsConsumed <= 250) {
            return (50 * 2.79) + (100 * 3.68) + (unitsConsumed - 150) * 4.1;
        } else {
            return (50 * 2.79) + (100 * 3.68) + (250 * 4.1) + (unitsConsumed - 400) * 5.2;
        }
    }
    ...
    double calculateBillRural(double unitsConsumed) {
        if (unitsConsumed <= 50) {
            ...
            return (50 * 1.5) + (unitsConsumed - 50) * 3.1;
        } else if (unitsConsumed <= 250) {
            return (50 * 1.5) + (100 * 3.1) + (unitsConsumed - 150) * 3.75;
        } else {
            return (50 * 1.5) + (100 * 3.1) + (250 * 3.75) + (unitsConsumed - 400) * 4.9;
        }
    }

    double calculateBillEducational(double unitsConsumed) {
        return (unitsConsumed * 4.35) + 50;
    }
    ...
    void compare() {
        ...
        switch (ch) {
            case 1:
                compareWithPreviousBill(amount, 890, "January");
                break;
            case 2:
                compareWithPreviousBill(amount, 885, "February");
                break;
            case 3:
                compareWithPreviousBill(amount, 1530, "March");
                break;
            case 4:
                compareWithPreviousBill(amount, 2850, "April");
                break;
            case 5:
                compareWithPreviousBill(amount, 3120, "May");
                break;
            case 6:
                compareWithPreviousBill(amount, 2960, "June");
                break;
            case 7:
                compareWithPreviousBill(amount, 2790, "July");
                break;
            case 8:
                compareWithPreviousBill(amount, 2502, "August");
                break;
            case 9:
                compareWithPreviousBill(amount, 2532, "September");
                break;
            case 10:
                compareWithPreviousBill(amount, 1878, "October");
                break;
            case 11:
                compareWithPreviousBill(amount, 1100, "November");
                break;
            case 12:
                compareWithPreviousBill(amount, 900, "December");
                break;
            default:
